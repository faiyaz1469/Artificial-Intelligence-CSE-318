...
// 1. Create a Model
        Model model = new Model("Futoshiki 03");
// 2. Create variables
...
// 3. Post constraints
        ...
        model.arithm (bd[1][2], "<", bd[2][2]).post();
        model.arithm (bd[1][4], "<", bd[1][5]).post();
        ...
        model.arithm (bd[2][2], "<", bd[3][2]).post();
        model.arithm (bd[2][6], ">", bd[3][6]).post();
        model.arithm (bd[2][7], "<", bd[2][8]).post();
        ...
        model.arithm (bd[4][1], "<", bd[5][1]).post();
        model.arithm (bd[4][5], "<", bd[4][6]).post();
