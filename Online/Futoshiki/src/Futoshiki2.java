...
// 1. Create a Model
        Model model = new Model("Futoshiki 02");
// 2. Create variables
...
// 3. Post constraints
        ...
        model.arithm (bd[0][1], "=", 3).post();
        model.arithm (bd[0][8], "=", 5).post();

        model.arithm (bd[1][3], "=", 4).post();
        model.arithm (bd[1][5], "=", 1).post();

        model.arithm (bd[2][7], "=", 6).post();

        model.arithm (bd[3][2], "=", 6).post();


        model.arithm (bd[4][2], "=", 3).post();
        model.arithm (bd[4][5], "=", 4).post();
        model.arithm (bd[4][7], "=", 7).post();


        model.arithm (bd[6][4], "=", 2).post();
        model.arithm (bd[6][5], "=", 3).post();
        model.arithm (bd[6][8], "=", 8).post();



        model.arithm (bd[8][6], "=", 4).post();

        //more constraints

        model.arithm (bd[0][1], ">", bd[1][1]).post();
        model.arithm (bd[0][2], ">", bd[1][2]).post();
        model.arithm (bd[0][3], ">", bd[0][4]).post();
        model.arithm (bd[1][6], "<", bd[1][7]).post();
        model.arithm (bd[1][6], ">", bd[2][6]).post();
        model.arithm (bd[1][7], ">", bd[1][8]).post();

        model.arithm (bd[2][0], "<", bd[2][1]).post();
        model.arithm (bd[2][6], ">", bd[3][6]).post();

        model.arithm (bd[3][1], "<", bd[3][2]).post();
        model.arithm (bd[3][2], "<", bd[3][3]).post();
        model.arithm (bd[3][3], ">", bd[3][4]).post();
        model.arithm (bd[3][7], ">", bd[3][8]).post();


        model.arithm (bd[4][2], ">", bd[4][3]).post();
        model.arithm (bd[4][6], ">", bd[5][6]).post();
        model.arithm (bd[4][7], ">", bd[4][8]).post();

        model.arithm (bd[5][0], ">", bd[5][1]).post();
        model.arithm (bd[5][2], ">", bd[6][2]).post();
        model.arithm (bd[5][2], "<", bd[5][3]).post();

        model.arithm (bd[6][3], "<", bd[7][3]).post();
        model.arithm (bd[6][6], "<", bd[7][6]).post();
        model.arithm (bd[6][7], ">", bd[7][7]).post();
        model.arithm (bd[6][7], "<", bd[6][8]).post();
        model.arithm (bd[6][8], ">", bd[7][8]).post();

        model.arithm (bd[7][0], "<", bd[7][1]).post();
        model.arithm (bd[7][2], "<", bd[8][2]).post();
        model.arithm (bd[7][6], "<", bd[7][7]).post();
